...
const createCourse = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const course = yield course_services_1.CourseServices.createCourse(req.body);
...
const getBestCourse = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const course = yield course_services_1.CourseServices.getCourseById(reviewsWithAverageRating[0]._id);
    (0, sendResponse_1.default)(res, {
        success: true,
        statusCode: 200,
